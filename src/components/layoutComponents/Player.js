...
function Player({ navBarState, playerTracks, setPlayerTracks }) {
    ...
    return (
        <div
            className="h-full flex flex-row items-center space-x-3 py-1 px-3"
            onClick={() => {
        ...
        >
            ...
            <div className="w-3/5 sm:w-6/12 md:w-1/3 h-full flex justify-start items-center">
                <div className="max-w-96 md:max-w-56 lg:max-w-72 w-fit flex items-center">
                    <TrackItem
                        ...
                        title="I Almost Do. All Too Well."
                        artist="Taylor Swift"
                        playerComponent
                    />
            ...
            <div className="w-3/5 sm:w-1/12 md:w-1/3 h-full flex items-center justify-end space-x-9">
                <div className="flex md:hidden flex-row items-center pr-3">
                    ...
                    <div className="dropdown flex items-center">
                        <div className="dropdown-content hidden justify-center items-center top-0 bottom-0 h-full w-44 px-5 rounded-full border z-50 border-[#d9d9d9] bg-[#084868]">
                            <button
                                className="size-10 rounded-full hover:bg-cyan-700 flex justify-center items-center"
                                onClick={(e) => {
                                    e.stopPropagation();
                                }}
                            >
                        ...
                        <button
                            className="dropbtn flex items-center justify-center size-10 rounded-full hover:bg-cyan-700"
                            onClick={(e) => {
                                e.stopPropagation();
                            }}
                        >
                ...
                <button
                    className="text-[#d9d9d9] hidden md:block"
                    onClick={(e) => {
                        e.stopPropagation();
                    }}
                >
    ...
    function TrackControls({ className, togglePlay }) {
        return (
            <div>
                <button onClick={(e) => { e.stopPropagation(); togglePlay() }} className="p-5 b">Play</button>
            </div>
        );
        ...
        //             <button
        //                 className="hidden md:flex items-center justify-center rounded-full size-9 hover:bg-cyan-700"
        //                 onClick={(e) => {
        //                     e.stopPropagation();
        //                 }}
        //             >
        ...
        //                 <button
        //                     className="flex items-center justify-center rounded-full size-9 hover:bg-cyan-700"
        //                     onClick={(e) => {
        //                         e.stopPropagation();
        //                     }}
        //                 >
        ...
        //                 </button>
        //                 <button
        //                     className="flex items-center justify-center bg-[#d9d9d9] hover:bg-[#ACACAC] size-11 rounded-full text-[#084868]"
        //                     onClick={(e) => {
        //                         e.stopPropagation();
        //                     }}
        //                 >
    ...
    function PlayerFull(props) {
        return (
            <div className="size-0 p-0 -mr-3">
                <section
                    className={
                        (navBarState ? `ml-60` : `ml-16`) +
                        ` fixed inset-0 mb-20 mt-16 bg-[#072C40] z-50 flex justify-center items-center`
                    }
                ...
                >
                    <div className="flex w-full h-full bc">
                        <div className="flex-1">album</div>
                        <ul className="w-96 flex flex-col">
                            {Object.values(playerTracks).map((track, index) => (
