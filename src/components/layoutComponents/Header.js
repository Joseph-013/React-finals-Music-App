    ...
    return (
        <section className="fixed top-0 left-0 w-full h-16 z-40 flex flex-row text-center">
            <div className="w-60 flex select-none">
                ...
                <Link className={(navBarState ? `` : ``) + ` flex-1 pl-3 flex justify-left items-center font-koulen space-x-2 text-2xl`} to="/">
            ...
            <div className="flex-1 flex justify-end sm:justify-between px-3 items-center">
                <div className="h-full hidden sm:flex items-center space-x-2">
                    <HeaderRoundedButton className="size-10" onClick={goBack}>
                        <IconChevronLeft />
                    </HeaderRoundedButton>
                    <HeaderRoundedButton className="size-10" onClick={goForward}>
                        <IconChevronRight />
                    </HeaderRoundedButton>
                </div>
