function IconCircleCheckFilled({ size, className }) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className={`icon icon-tabler icon-tabler-circle-check-filled ${className}`} width={size || `25`} height={size || `25`} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
