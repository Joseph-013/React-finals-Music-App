    ...
    function TrackItemContext() {
        ...
        return (
            <div className="relative">
                ...
                <ul className={`py-2 absolute max-h-64 overflow-y-auto w-48 z-20 left-0 -translate-y-1/2 top-1/2 -translate-x-full bg-gray-700 ${contextDisplay}`}
                    onMouseEnter={() => setContextDisplay("block")}
                    onMouseLeave={() => setContextDisplay("hidden")}
                >
                    <li className="h-12 px-2 flex items-center hover:bg-slate-500">Add to Favorites</li>
                    <li className="h-12 px-2 flex items-center hover:bg-slate-500">Playlist 1</li>
                    <li className="h-12 px-2 flex items-center hover:bg-slate-500">Playlist 2</li>
                    <li className="h-12 px-2 flex items-center hover:bg-slate-500">Playlist 3</li>
                    <li className="h-12 px-2 flex items-center hover:bg-slate-500">Playlist 3</li>
                    <li className="h-12 px-2 flex items-center hover:bg-slate-500">Playlist 3</li>
                    <li className="h-12 px-2 flex items-center hover:bg-slate-500">Playlist 3</li>
                </ul>
